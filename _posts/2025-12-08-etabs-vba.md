...
# --- CẤU HÌNH HERO IMAGE ---
header:
  overlay_image: /assets/images/hero-engineering.jpg  # Đường dẫn đến ảnh bìa to
  overlay_filter: 0.5  # Độ tối của lớp phủ (0.0 -> 1.0). Giúp chữ trắng dễ đọc hơn.
  caption: "Photo credit: [**HydroStruct AI**](https://hydrostructai.com)" # (Tùy chọn) Chú thích ảnh nhỏ góc dưới
  # actions: # (Tùy chọn) Thêm nút kêu gọi hành động ngay trên ảnh
  #   - label: "Tải Tool Ngay"
  #     url: "/downloads/etabs-tool.zip"
  #     class: "btn--light-outline btn--large"

# Ảnh này dùng cho thumbnail (lưới bài viết) và chia sẻ Facebook
