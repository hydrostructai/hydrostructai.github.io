...
<div class="page__hero--overlay">
  <div class="wrapper">
    ...
    <p class="page__lead" style="color: white; text-align: center; font-size: 1.2rem; max-width: 800px; margin: 0 auto;">
      Advanced finite element analysis tools powered for structural and geotechnical engineering professionals.
    </p>
  </div>
</div>
        ...
        <div class="app-card">
          ...
          <div class="app-card-body">
            <h3 class="app-card-title">
              <i class="bi bi-arrow-right-square-fill"></i> Lateral Pile
            </h3>
            <div class="app-card-badges">
              <span class="badge bg-primary">Nonlinear FEM</span>
              <span class="badge bg-danger">p-y Curves</span>
              <span class="badge bg-info">TCVN/API</span>
            </div>
            <p class="app-card-description">
              Specialized analysis for single piles under lateral loads and moments. It utilizes nonlinear p-y curves 
              to simulate soil-structure interaction according to TCVN 10304:2025 and API RP2A standards. 
              Provides comprehensive outputs including deflection, bending moment, shear force, and soil reaction profiles.
            </p>
            <div class="app-card-features">
              <h6><i class="bi bi-check-circle-fill text-success"></i> Key Features:</h6>
              <ul>
                <li>Nonlinear p-y curve analysis (Sand/Clay)</li>
                <li>Support TCVN 10304, API RP2A, Eurocode</li>
                <li>Multi-layered soil modeling</li>
                <li>Head conditions: Free, Fixed, Spring</li>
                <li>Structural capacity check</li>
                <li>Interactive result charts (Deflection, Moment)</li>
              </ul>
            </div>
        ...
        <div class="app-card">
          ...
          <div class="app-card-body">
            ...
            <p class="app-card-description">
              ...
              (struts, ground anchors). Ideal for deep excavation projects.
            </p>
            <div class="app-card-features">
              <h6><i class="bi bi-check-circle-fill text-success"></i> Key Features:</h6>
              <ul>
                <li>Multi-stage excavation analysis</li>
                <li>Advanced anchor modeling (elevation, angle)</li>
                <li>Soil-structure interaction (Elasto-plastic)</li>
                <li>Point loads and distributed surcharge</li>
                <li>Water pressure & seepage calculations</li>
                <li>Detailed output: deflection, moments, shear</li>
              </ul>
            </div>
            <div class="app-card-footer">
        ...
        <div class="app-card">
          ...
          <div class="app-card-body">
            ...
            <p class="app-card-description">
              ...
              It calculates internal forces and displacements of high-rise building foundations. 
              Perfect for optimizing pile cap designs with flexible layouts.
            </p>
            <div class="app-card-features">
              <h6><i class="bi bi-check-circle-fill text-success"></i> Key Features:</h6>
              <ul>
                <li>3D pile group analysis (Zavriev-Spiro)</li>
                <li>Vertical and inclined pile support</li>
                <li>Flexible pile layout (Custom coordinates)</li>
                <li>Soil layer modeling with spring constants</li>
                <li>Combined loading: axial, shear, moment, torsion</li>
                <li>Pile cap displacement visualization</li>
              </ul>
            </div>
            <div class="app-card-footer">
    ...
    <div class="row mt-5">
      <div class="col-12">
        <div class="info-box" style="background: white; padding: 2rem; border-radius: 8px; box-shadow: 0 2px 12px rgba(0,0,0,0.08);">
          ...
          <p>
            All applications utilize <strong>WebAssembly (WASM)</strong> technology, which compiles high-performance 
...
.app-card-image {
  width: 100%;
  height: 220px; /* Adjusted height slightly for 3-row layout */
  overflow: hidden;
...
.app-card-description {
  ...
  font-size: 0.95rem;
  flex-grow: 1; /* Makes descriptions align */
}
...
.info-item h6 { margin-top: 0.5rem; font-weight: 600; }
.info-item p { margin: 0; color: #6c757d; font-size: 0.9rem; }
.tools-list ul { list-style: none; padding: 0; }
.tools-list li { padding: 0.5rem 0; border-bottom: 1px solid #e9ecef; }
.tools-list li:last-child { border-bottom: none; }
.tools-list a { text-decoration: none; color: #0d6efd; transition: color 0.2s; }
.tools-list a:hover { color: #0b5ed7; }

@media (max-width: 768px) {
  .app-card-image { height: 200px; }
  .app-card-title { font-size: 1.5rem; }
}
</style>